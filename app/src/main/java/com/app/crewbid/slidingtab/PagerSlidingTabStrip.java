package com.app.crewbid.slidingtab;
...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	private int intialSelectedIndex = 0;
	...
	private void addTextTab(final int position, String title) {
		...
		// tab.setTypeface(ApplicationElDorado.LATO_BOLD);
		tab.setText(title);
	...
	private void updateTabStyles() {
		...
		for (int i = 0; i < tabCount; i++) {
			...
			if (v instanceof TextView) {
				...
				if (i == intialSelectedIndex) {
					tab.setTextColor(getContext().getResources().getColor(
							R.color.colorStripDark));
				} else {
					tab.setTextColor(getContext().getResources().getColor(
							R.color.colorStripLight));
				}
	...
	public void setTabSelected(int selected) {
		this.intialSelectedIndex = selected;
		updateTabStyles();
	}
